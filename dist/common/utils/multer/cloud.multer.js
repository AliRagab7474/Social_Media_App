...
const cloudFileUpload = ({ storageApproach = enums_1.multerApproachEnum.MEMORY, validation = [], maxSize = 2, }) => {
    const storage = storageApproach == enums_1.multerApproachEnum.MEMORY
